    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.paragraph}>
          ...
          policy explains what data we collect, how it is used, how it is stored, and the rights you
        ...
        <Text style={styles.paragraph}>
          We <Text style={styles.bold}>do not sell</Text> your data. Information may be shared only
          with trusted infrastructure providers or when legally required. All communication uses
          HTTPS and passwords are hashed.
        </Text>
